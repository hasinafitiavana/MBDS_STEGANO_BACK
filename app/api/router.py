...
from app.api.v1.endpoints import steganography_test_controller
...
router.include_router(steganography_test_controller.router, prefix="/stegano", tags=["Steganography"])
